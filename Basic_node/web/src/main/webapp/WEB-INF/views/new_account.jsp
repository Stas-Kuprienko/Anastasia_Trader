...
<head>
    ...
    <meta property="og:url" content="http://localhost8081.tilda.ws/page51131525.html">
    <meta property="og:title" content="/new_account">
    <meta property="og:description" content="">
    <meta property="og:type" content="website">
    <meta property="og:image" content="https://static.tildacdn.info/tild3962-6331-4861-b532-313739343466/-22111.png">
    <link rel="canonical" href="http://localhost8081.tilda.ws/page51131525.html"><!--/metatextblock-->
    ...
    <link rel="stylesheet" href="/anastasia/style/tilda-blocks-page51131525.min.css" type="text/css" media="all"
          onerror="this.loaderr=&#39;y&#39;;">
    ...
    <script src="/anastasia/style/tilda-blocks-page51131525.min.js" charset="utf-8" async=""
            onerror="this.loaderr=&#39;y&#39;;"></script>
...
<div id="allrecords" class="t-records t-records_animated t-records_visible" data-hook="blocks-collection-content-node"
     data-tilda-project-id="9588603" data-tilda-page-id="51131525"
     data-tilda-formskey="c760884931208f612fcce878e9588603" data-tilda-cookie="no" data-tilda-lazy="yes"
     data-tilda-root-zone="com">
    <div id="rec766235361" class="r t-rec" style=" " data-animationappear="off" data-record-type="456"><!-- T456 -->
        <div id="nav766235361marker"></div>
        <div class="tmenu-mobile tmenu-mobile_positionfixed">
            <div class="tmenu-mobile__container">
                ...
                t_onReady(function() {
                    t_onFuncLoad('t_menuburger_init', function(){t_menuburger_init('766235361');});
                });</script>
                <style>.t-menuburger {
                    position: relative;
                    flex-shrink: 0;
        ...
        @media screen and (max-width: 980px) {
            #rec766235361 .tmenu-mobile {
                background-color: #8f6482;
            }
            #rec766235361 .tmenu-mobile__menucontent_fixed {
                position: fixed;
                top: 64px;
            }
            #rec766235361 .t-menuburger {
                -webkit-order: 1;
                -ms-flex-order: 1;
                order: 1;
            }
        }</style>
        <style> #rec766235361 .tmenu-mobile__burgerlogo a { color: #ffffff; }</style>
        <style> #rec766235361 .tmenu-mobile__burgerlogo__title { color: #ffffff; }</style>
        <div id="nav766235361" class="t456 tmenu-mobile__menucontent_hidden tmenu-mobile__menucontent_fixed"
             style="background-color: rgba(220,58,170,0.10); " data-bgcolor-hex="#dc3aaa"
             data-bgcolor-rgba="rgba(220,58,170,0.10)" data-navmarker="nav766235361marker" data-appearoffset=""
        ...
        <style>@media screen and (max-width: 980px) {
            #rec766235361 .t456__logowrapper{
                display: none!important;
            }
            #rec766235361 .t456__mobile-text{
                display: none;
            }
            #rec766235361 .t456__imglogo{
                padding: 0;
            }
        }</style>
        <style>@media screen and (max-width: 980px) {
            #rec766235361 .t456__leftcontainer{
                padding: 20px;
            }
        }
        @media screen and (max-width: 980px) {
        ...
        <script type="text/javascript">t_onReady(function() {
            ...
            t_onFuncLoad('t_menu__findAnchorLinks', function () {
                t_menu__findAnchorLinks('766235361', '.t456__list_item a');
            });
        });
        t_onReady(function () {
            t_onFuncLoad('t_menu__setBGcolor', function () {
                t_menu__setBGcolor('766235361', '.t456');
                window.addEventListener('resize', function () {
                    t_menu__setBGcolor('766235361', '.t456');
                });
            });
            t_onFuncLoad('t_menu__interactFromKeyboard', function () {
                t_menu__interactFromKeyboard('766235361');
            });
        });</script>
        <script type="text/javascript">t_onReady(function () {
            t_onFuncLoad('t_menu__createMobileMenu', function () {
                t_menu__createMobileMenu('766235361', '.t456');
            });
        });</script>
        <style>#rec766235361 .t-menu__link-item{
            -webkit-transition: color 0.3s ease-in-out, opacity 0.3s ease-in-out;
            transition: color 0.3s ease-in-out, opacity 0.3s ease-in-out;
        }
        #rec766235361 .t-menu__link-item.t-active:not(.t978__menu-link){
            color:#7e058c !important; }
        #rec766235361 .t-menu__link-item:not(.t-active):not(.tooltipstered):hover {
            color: #6135d2 !important; }
        #rec766235361 .t-menu__link-item:not(.t-active):not(.tooltipstered):focus-visible{
            color: #6135d2 !important; }
        @supports (overflow:-webkit-marquee) and (justify-content:inherit)
        {
            #rec766235361 .t-menu__link-item,
            #rec766235361 .t-menu__link-item.t-active {
                opacity: 1 !important;
            }
        }</style>
        <style> #rec766235361 .t456__logowrapper a { color: #ffffff; } #rec766235361 a.t-menu__link-item { font-size: 28px; color: #ffffff; font-weight: 600; }</style>
        <style> #rec766235361 .t456__logo { color: #ffffff; }</style>
        <!--[if IE 8]>
        <style>#rec766235361 .t456 {
filter: progid:DXImageTransform.Microsoft.gradient(startColorStr='#D9dc3aaa', endColorstr='#D9dc3aaa');
}
        </style><![endif]-->
        <style>#rec766235361 .t456 {box-shadow: 0px 2px 3px rgba(0,11,48,0.25);}</style>
    </div>
    <div id="rec766231016" class="r t-rec t-rec_pt_120 t-rec_pb_60 r_showed r_anim"
                ...
                <div class="t-col t-col_8 t-prefix_2">
                    <div>
                        <form id="form766231016" name="form766231016" role="form"
                              action="/anastasia/user/account" method="POST"
                              data-formactiontype="0" data-inputbox=".t-input-group"
                              data-success-callback="t678_onSuccess"><!-- NO ONE SERVICES CONNECTED --> <input
                                type="hidden" name="tildaspec-formname" tabindex="-1" value="Создание торгового счёта">
                            <div class="js-successbox t-form__successbox t-text t-text_md" aria-live="polite"
                                 style="display:none;" data-success-message="Сохраняется счёт"></div>
                            <div class="t-form__inputsbox t-form__inputsbox_vertical-form t-form__inputsbox_inrow">
                                <div class="t-input-group t-input-group_sb " data-input-lid="5527479220180"
                                     data-field-type="sb"><label for="input_5527479220180"
                                                                 class="t-input-title t-descr t-descr_md"
                                                                 id="field-title_5527479220180"
                                                                 data-redactor-toolbar="no"
                                                                 field="li_title__5527479220180"
                                                                 style="color:;">Брокер</label>
                                    <div class="t-input-block ">
                                        <div class="t-select__wrapper "><select name="broker" id="input_5527479220180"
                                ...
                                <div class="t-input-group t-input-group_in " data-input-lid="1716496121972"
                                     data-field-type="in"><label for="input_1716496121972"
                                                                 class="t-input-title t-descr t-descr_md"
                                                                 id="field-title_1716496121972"
                                                                 data-redactor-toolbar="no"
                                                                 field="li_title__1716496121972" style="color:;">ID
                                    клиента</label>
                                    <div class="t-input-block "><input type="text" name="clientId"
                                ...
                                <div class="t-input-group t-input-group_in " data-input-lid="5527479220182"
                                    ...
                                    <div class="t-input-block "><input type="password" name="token" id="input_5527479220182"
                                                                       class="t-input js-tilda-rule " value=""
                                                                       data-tilda-req="1" aria-required="true"
                                ...
                                <div class="t-form__submit">
                                    <button type="submit" class="t-submit"
                                            ...
                                            data-field="buttontitle" data-buttonfieldset="button">Создать счёт
                                    </button>
                                </div>
                            </div>
        ...
        <style>#rec766231016 .t-submit {position: relative;overflow: hidden;z-index: 1;}#rec766231016 .t-submit::after {content: '';position: absolute;top: 0;left: 0;right: 0;bottom: 0;z-index: -1;width: 100%;height: 100%;opacity: 0;transition: opacity 0.2s ease-in-out;background-image: linear-gradient(0.75turn,rgba(63,50,123,1) 0%,rgba(153,106,139,1) 50%,rgba(63,50,123,1) 100%);}@media (hover: hover), (min-width: 0\0) {#rec766231016 .t-submit:hover::after {opacity: 1;}#rec766231016 .t-submit:focus-visible::after {opacity: 1;}}@media (hover: hover), (min-width: 0\0) {#rec766231016 .t-submit:hover {animation-name: rec_766231016_btnanim;animation-duration: 0s;animation-fill-mode: forwards;animation-delay: 0.2s;animation-timing-function: linear;}#rec766231016 .t-submit:focus-visible {animation-name: rec_766231016_btnanim;animation-duration: 0s;animation-fill-mode: forwards;animation-delay: 0.2s;animation-timing-function: linear;}}@keyframes rec_766231016_btnanim {to {background-image: none;background-color: transparent;}}@media (hover: hover), (min-width: 0\0) {#rec766231016 .t-submit:hover {box-shadow: 0px 2px 3px rgba(0,11,48,0.25) !important;}#rec766231016 .t-submit:focus-visible {box-shadow: 0px 2px 3px rgba(0,11,48,0.25) !important;}}</style>
    </div>
    <div id="rec766231017" class="r t-rec t-rec_pt_0 t-rec_pb_0" style="padding-top:0px;padding-bottom:0px; "
         data-animationappear="off" data-record-type="18"><!-- cover -->
        <div class="t-cover" id="recorddiv766231017" bgimgfield="img"
            ...
            <div class="t-cover__carrier loaded" id="coverCarry766231017" data-content-cover-id="766231017"
                 ...
                 style="height: 231.93px; background-image: url(&quot;https://optim.tildacdn.pub/tild3965-3939-4637-b661-343966356332/-/format/webp/trade_app_background.png&quot;);"
        ...
        <style> #rec766231017 .t001__uptitle { text-transform: uppercase; }</style>
    </div>
</div>
